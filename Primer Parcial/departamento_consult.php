                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo "<a href='ver_dep_consult.php?iddepartamento=". $row['iddepartamento'] ."' title='Ver información' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a>";
