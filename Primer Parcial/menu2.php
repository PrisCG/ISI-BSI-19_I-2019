...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <a class="navbar-brand" href="menu2.php">Inicio</a>
  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="empleados_consult.php">Empleados <img src="Users.png"> <span class="sr-only"></span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="departamento_consult.php"> Departamentos <img src="Departamento.png"></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="acciones_consult.php">Acciones <img src="acciones.png"></a>
      </li>
      <li class="nav-item">
