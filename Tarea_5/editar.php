...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($titulo_err) && empty($autor_err) && empty($editorial_err) && empty($precio_err)){
        ...
        $sql = "UPDATE libreria SET titulo=?, autor=?, editorial=?, precio=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            
            mysqli_stmt_bind_param($stmt, "ssssi", $param_titulo, $param_autor, $param_editorial, $param_precio, $param_id);
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Todos los campos del formulario debe ser llenados.</p>
